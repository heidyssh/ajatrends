      ...
      <div class="app-shell">
        <aside id="sidebar" class="sidebar">
          ...
          <nav class="navs">
            ...
            <a class="nav-item <?= $page === 'reports' ? 'active' : '' ?>" href="index.php?page=reports">
          ...
          <header class="topbar topbar-pro module-topbar">
            ...
            <div class="right d-flex align-items-center gap-2 gap-sm-3">
              ...
              <a href="https://www.instagram.com/aja_trends?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                target="_blank" rel="noopener noreferrer" class="icon-btn" title="Instagram AJA Trends">
                ...
                <div id="notifDropdown" class="dropdown-menu dropdown-menu-end shadow-sm p-2 notif-dropdown">
                  <div class="d-flex align-items-center justify-content-between px-2 py-1">
                    ...
                    <?php if (!empty($notifItems)): ?>
                      <button type="button" id="btnClearAllNotifications" class="btn btn-sm btn-outline-danger">
                  ...
                  <?php else: ?>
                    ...
                    <?php foreach ($notifItems as $n): ?>
                      ...
                      <div class="notif-item d-flex justify-content-between align-items-start">
                        ...
                        <button class="btn btn-sm btn-light notif-delete ms-2" type="button"
