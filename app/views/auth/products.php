    ...
    <div class="bd">
      ...
      <form class="purchases-filters filters-glass d-none d-md-flex" method="get" action="index.php">
        ...
        <div class="filter">
          ...
          <div class="input-group input-group-sm">
            ...
            <input class="form-control form-control-sm" name="q" value="<?= h($q) ?>" placeholder="SKU o nombre...">
          </div>
        </div>
        ...
        <div class="filter actions">
          <div class="actions">
            ...
            <button class="btn btn-light btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#prodMore"
              aria-expanded="false" aria-controls="prodMore">
        ...
        <div class="collapse filters-more" id="prodMore">
          <div class="more-grid">
            <div>
              ...
              <input class="form-control form-control-sm" type="number" step="0.01" name="min" value="<?= h($min) ?>">
            </div>
            <div>
              <label class="form-label">Precio max</label>
              <input class="form-control form-control-sm" type="number" step="0.01" name="max" value="<?= h($max) ?>">
            </div>
            <div>
      ...
      <div class="chips mt-3">
        ...
        <?php foreach ($categories as $c): ?>
          ...
          <a class="chip <?= $idc === $cat ? 'active' : '' ?>"
            href="index.php?page=products&cat=<?= $idc ?><?= $q !== '' ? ('&q=' . urlencode($q)) : '' ?>">
            <?= h($c['nombre']) ?>
          </a>
        <?php endforeach; ?>
      </div>
                ...
                <div class="price-row">
                  ...
                  <div class="ms-auto">
                    <?php if ($isAdmin): ?>
                      ...
                      <button class="btn btn-sm btn-light btn-mini" type="button" data-delete-id="<?= $id ?>"
                        title="Eliminar">
            ...
            <div class="modal-body">
              <div class="row g-2">
                ...
                <div class="col-12">
                  ...
                  <textarea class="form-control" name="descripcion" id="pfDesc" rows="3"
                ...
                <div class="col-12">
                  ...
                  <div class="form-text">Tip: la primera imagen subida queda como principal (luego se puede cambiar).
                  </div>
                </div>
