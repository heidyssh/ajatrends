...
$viewMode = $viewData['viewMode'] ?? 'day';
$allEvents = $viewData['allEvents'] ?? [];
...
<div class="page-fade agenda-page">
  ...
  <div class="cardx mb-4 module-hero">
    <div class="hd d-flex align-items-start justify-content-between flex-wrap gap-3">
      <div>
        <div class="fw-bold" style="font-size:1.15rem;">Agenda </div>
      ...
      <div class="d-flex gap-2 flex-wrap">
        ...
        <a class="btn btn-primary" href="index.php?page=agenda&date=<?= h(date('Y-m-d')) ?>">Hoy</a>
